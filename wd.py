...
# -*- coding: utf-8 -*-
#%%
"""wd.py — Weighted phonological Levenshtein distance + normalized similarities.

This module computes a phonology-aware edit distance between phonetic/orthographic
transcriptions using:
  - grapheme tokenization in NFD (base + combining diacritics)
  - optional boundary tokens for whitespace/separators
  - feature-based substitution costs for known bases
  - small penalties for diacritic differences
...
Notes
-----
- Cells can contain multiple variants separated by '/'. For concept similarity we
  return the MAX similarity across variant pairs.
- Unknown symbols fall back to a moderate cost within the same broad class (V/C)
  and a higher cost across classes.
"""
...
if __name__ == "__main__":
    x = "u lárgu / áltu má̄re"
    y = "u lárgu / l-áltu máre"
    print("similarity =", concept_similarity_normalized(x, y))
